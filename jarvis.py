...
if __name__ == "__main__":
    ...
    # loop for tasks if 1:
        ...
        #         content = takeCommand()
        #         to = "bhargavsable@gmail.com"    
        #         sendEmail(to, content)
        #         speak("Email has been sent!")
        #     except Exception as e:
        #         print(e)
        #         speak("Sorry my friend bhargav bhai. I am not able to send this email")   make less secure apps enable in gmail id from where you want to send email